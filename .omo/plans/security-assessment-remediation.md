# security-assessment-remediation - Work Plan
...
- Evidence: <attemptDir>/task-<N>-security-assessment-remediation.<ext> (attemptDir = currentAttemptDir from 'omo ulw-loop status --json', .omo/evidence/ulw/<session>/<goalId>/a<attempt>; outside ulw-loop use .omo/evidence/)
