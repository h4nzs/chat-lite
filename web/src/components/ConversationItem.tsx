...
export default memo(function ConversationItem({ 
  ...
  const renderPreviewText = () => {
    ...
    // Use preview field if available (generated by withPreview())
    if (conversation.lastMessage.preview !== undefined && conversation.lastMessage.preview !== null) {
        const preview = conversation.lastMessage.preview;
        if (preview === '') return 'No messages yet';
        return preview;
    }
    
    // Fallback for view-once messages
    ...
    // Fallback for edited messages
    if (conversation.lastMessage.isEdited) {
