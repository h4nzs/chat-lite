  ...
  return (
    <div className="h-full flex flex-col bg-surface">
      ...
      <div className="p-4 border-b border-gray-800">
        ...
        {isSearching && <button onClick={() => setSearching(false)} className="text-xs text-accent mt-2 hover:underline">Cancel Search</button>}
      </div>

      <div className="flex-1 overflow-y-auto">
        {isSearching ? (
          <StartNewChat onStarted={(id) => { onOpen(id); setSearching(false); }} />
