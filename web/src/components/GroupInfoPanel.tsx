...
const GroupInfoPanel = ({ conversationId, onClose }: { conversationId: string; onClose: () => void; }) => {
  ...
  return (
    <div className="absolute top-0 right-0 h-full w-full max-w-md bg-surface border-l border-gray-800 z-50 flex flex-col">
      <div className="p-4 border-b border-gray-800 flex items-center">
        <button onClick={onClose} className="p-2 -ml-2 mr-2 text-text-secondary hover:text-white">
