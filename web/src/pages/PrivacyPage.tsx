...
const Section = ({ title, icon: Icon, children, id }: { title: string; icon: React.ComponentType<{ size?: number | string; className?: string }>; children: React.ReactNode; id: string }) => (
